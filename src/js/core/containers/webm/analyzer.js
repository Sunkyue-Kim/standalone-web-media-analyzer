...
const MASTER_ELEMENT_IDS = new Set([
  0x1a45dfa3, 0x18538067, 0x114d9b74, 0x1549a966, 0x1654ae6b, 0xae, 0xe0, 0xe1, 0x1f43b675, 0xa0
]);

const UNSIGNED_INTEGER_IDS = new Set([0x4286, 0x42f7, 0x42f2, 0x42f3, 0x4287, 0x4285, 0x2ad7b1, 0xd7, 0x73c5, 0x83, 0x23e383, 0xb0, 0xba, 0x9f, 0x6264, 0xe7]);
const STRING_IDS = new Set([0x4282, 0x86]);
