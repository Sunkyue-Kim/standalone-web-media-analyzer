export const I18N = {
  en: {
    ...
    "preview.remoteFetchDeferred": "preview fetch deferred until playback",
    "tab.summary": "Summary",
    "tab.boxes": "Boxes",
    "tab.tracks": "Tracks",
    "tab.frames": "Frames",
    ...
    "warning.remotePreviewDeferred": "Remote preview preload was disabled to avoid duplicate network traffic. Playing or seeking the preview may let the browser fetch the media separately.",
    "warning.remoteSharedDownloadFailed": "Single-download playback reuse failed, so range analysis continued with preview fetch deferred. {message}",
    "box.field.type": "type",
  ...
  ko: {
    ...
    "preview.remoteFetchDeferred": "재생 전까지 preview fetch 지연",
    "tab.summary": "요약",
    "tab.boxes": "박스",
    "tab.tracks": "트랙",
    "tab.frames": "프레임",
    ...
    "warning.remotePreviewDeferred": "중복 네트워크 트래픽을 피하려고 원격 preview preload를 비활성화했습니다. preview를 재생하거나 seek하면 브라우저가 미디어를 별도로 가져올 수 있습니다.",
    "warning.remoteSharedDownloadFailed": "단일 다운로드 기반 재생 공유에 실패해 preview fetch를 지연한 상태로 range 분석을 계속했습니다. {message}",
    "box.field.type": "타입",
